	...
	public function action_init_register_post_type() {
		...
		register_post_type( self::POST_TYPE_TAXONOMY, array(
			'labels' => array(
				...
				'add_new_item'  => __( 'Step 1: Tell us about your '. self::TAXONOMY_SINGULAR . '. ' . 'Don\'t worry. You can always update it later.'),
				'edit_item'     => __( 'Editing ' . self::TAXONOMY_SINGULAR . ' Details. What is your '.self::TAXONOMY_SINGULAR. ' about?'),
	...
	public function action_init_register_taxonomy() {
		register_taxonomy( self::TAXONOMY_SLUG, array_merge( $this->post_types, array( self::POST_TYPE_TAXONOMY ) ) , array(
			'labels' => array(
				...
				'edit_item'         => __( 'Editing ' . self::TAXONOMY_SINGULAR ),
